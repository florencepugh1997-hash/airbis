        ...
        <div className="bg-white min-h-screen py-16">
            <div className="container mx-auto px-4 max-w-4xl text-gray-600">
                ...
                <section className="space-y-6">
                    <p>
                        By accessing or using the Airbis platform, you agree to be bound by these Terms.
                    </p>
                    ...
                    <p>
                        Airbis guarantees that all parts are supplied with appropriate certification (FAA 8130/EASA Form 1) where indicated. It is the installer's responsibility to determine airworthiness before installation.
                    </p>

                    <h2 className="text-2xl font-bold text-[#0a1e3d]">4. Liability</h2>
                    <p>
                        To the maximum extent permitted by law, Airbis shall not be liable for any indirect, incidental, or consequential damages arising from the use or inability to use our products.
                    </p>
                </section>
            </div>
        </div>
